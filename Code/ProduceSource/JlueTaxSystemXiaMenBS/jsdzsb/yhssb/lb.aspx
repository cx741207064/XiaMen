<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lb.aspx.cs" Inherits="JlueTaxSystemXiaMenBS.jsdzsb.yhssb.lb" %>
...
<body>
    ...
    function txsbb(){
        ...
        if(xgbz=="yes"){
            ...
            $("#myForm2").attr("action","/jsdzsb/yhssb/txsbb.aspx"); 
            $("#myForm2").submit();
        }
    }
    //增加记录时检测是否为空
        ...
        <form action="/jsdzsb/yhssb/lb.do" method="post" id="myForm3">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
			 ...
			 <input type="hidden" name="sbbVo['skssqz']" value="2018-08-31" />
              ...
              <input type="hidden" name="sbbVo['zspmdm']" id="zspmdm" value="" />
                            </td>
                            <td>
                                <label></label>
                            </td>
                ...
                <td>
                    <table width="100%" border="0" class="border h12_b" style="margin-top: 10px;">
                        ...
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td>
                                <input name="sbbVo['sysl']" type="hidden" value="">
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                ...
                <td>
                    <table width="100%" border="0" class="border h12_b" style="margin-top: 10px;">
                        ...
                        <input type="hidden" name="sbbVo['hdlx']" value="" />
