<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="submitSbb.aspx.cs" Inherits="JlueTaxSystemXiaMenBS.jsdzsb.yhssb.submitSbb" %>
...
<head>
    ...
    <script type="text/javascript">
        var p0,p1,p2,p3,p4,p5, p6, p7, p8, p9, p10, p11, p12, p13
        var index
        ...
        $(function(){
            ...
            addOneRow(p0,p1,p2,p3,p4,p5, p6, p7, p8, p9, p10, p11, p12, p13)

            $("#yhstxsbb").on("click","#btnQrtj",function(){
                p2= getObj("zspmdm").value

                p5=getObj("sbbVo['bqybtse']").value

                p6=getObj("sbbVo['hdzshdde']").value

                p7=getObj("sbbVo['hdzshdbl']").value

                p8=getObj("sbbVo['jsje']").value

                p9=getObj("sysl").value

                p10=getObj("sbbVo['bqynse']").value

                p11=getObj("sbbVo['jmse']").value

                p12=getObj("sbbVo['ssjmxzdm']").value

                p13=getObj("sbbVo['bqyjse1']").value

                modifyOneRow(index,p0,p1,p2,p3,p4,p5, p6, p7, p8, p9, p10, p11, p12, p13)
            })
        })
    </script>
...
<body>
    ...
    function tjsbjl(){
        ...
        var temp_data= $("#frm_dfsf").children("tbody").eq(1).html()
        document.getElementById("temp_data").setAttribute("value",temp_data)


        $("#myForm1").attr("action","/jsdzsb/yhssb/tjsbjl.aspx");  
        $("#myForm1").submit();
    }
    function tjsbb(){
		  
        $("#myForm1").attr("action","/jsdzsb/yhssb/tjsblb.ashx");  
        $("#myForm1").submit();
    }
    function tjsbbsb(){
    ...
    function qxbcsb(){
        ...
        if(confirm("是否确定取消本次申报？")){
            if(xgbz=='yes')
                location.href="/jsdzsb/yhssb/index.aspx?xgbz=yes";
            if(xgbz=='no')   
                location.href="/jsdzsb/yhssb/index.aspx";
        }
    }
    function txsbb(){
    ...
    <div id='yhssblb'>
        <form action="/jsdzsb/yhssb/lb.do" method="post" id="myForm1">
            ...
            <input type="hidden" id="temp_data" name="temp_data" runat="server" />
            <input type="hidden" id="tmp_count" name="tmp_count" value="0" runat="server" />
      ...
      <td class="gray3_bg_color"></td>
          ...
          <input type="checkbox" name="sbbVo['nsrlx']" value="2" disabled="disabled" />
                            ...
                            <tr>
                                ...
                                <td nowrap="nowrap" id="DJZCLX"></td>
                                <td nowrap="nowrap">所属行业</td>
                                <td nowrap="nowrap"></td>
                            </tr>
                            <tr>
                                <td nowrap="nowrap">联系方式</td>
                                <td nowrap="nowrap" id="LXDH"></td>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td align="center" nowrap>
                                        <a href="#" onclick="modify('06000002000000000000000131941766')">修改</a>&nbsp;&nbsp; 
                    
                    <a href="#" onclick="del('06000002000000000000000131941766')">删除</a>&nbsp;&nbsp;
                    
                                    </td>
                                    <td align="center" nowrap>印花税&nbsp;
                                    </td>
                                    <td align="center" nowrap>印花税-
...
其他凭证&nbsp;
                                    ...
                                    <td align="center" nowrap>2018-08-01&nbsp;
                                    </td>
                                    <td align="center" nowrap>2018-08-31&nbsp;
                                    </td>
                                    <td align="center" nowrap style="color: Maroon">1.2&nbsp;
                   <input type="hidden" name="sbbList[0]['SJYZE']" value="1.2" />
                                    </td>
                                    <td align="center" nowrap>&nbsp;
                                    </td>
                                    <td align="center" nowrap>&nbsp;
                                    </td>
                                    <td align="center" nowrap>12&nbsp;
                                    </td>
                                    <td align="center" nowrap>0.1&nbsp;
                                    </td>
                                    <td align="center" nowrap>1.2&nbsp;
                                    </td>
                                    <td align="center" nowrap>0&nbsp;
                                    </td>
                                    <td align="center" nowrap>&nbsp;
                                    </td>
                                    <td align="center" nowrap>&nbsp;
                                ...
                                <tr>
                                    <td align="center" nowrap>
                                        <a href="#" onclick="modify('06000002000000000000000131942780')">修改</a>&nbsp;&nbsp; 
                    
                    <a href="#" onclick="del('06000002000000000000000131942780')">删除</a>&nbsp;&nbsp;
...
加工承揽合同&nbsp;
                                    ...
                                    <td align="center" nowrap style="color: Maroon">0&nbsp;
                   <input type="hidden" name="sbbList[1]['SJYZE']" value="0" />
                                    </td>
                                    <td align="center" nowrap>&nbsp;
                                    </td>
                                    <td align="center" nowrap>&nbsp;
                                    </td>
                                    <td align="center" nowrap>33&nbsp;
                                    </td>
                                    <td align="center" nowrap>0.0005&nbsp;
                                    </td>
                                    <td align="center" nowrap>0.02&nbsp;
                                    </td>
                                    <td align="center" nowrap>0&nbsp;
                                    </td>
                                    <td align="center" nowrap>&nbsp;
...
<!--
			 ...
			 <input type="hidden" name="sbbVo['skssqz']" value="2018-08-31" />
              ...
              <input type="hidden" name="sbbVo['zsxmdm']" value="10111" />
                        ...
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td><label id="zspmText">印花税-加工承揽合同</label>
              <input type="hidden" name="zspmdm" id="zspmdm" value="101110102" />
                            </td>
                            <td>
                                <label></label>
                            </td>
                ...
                <td>
                    <table width="100%" border="0" class="border h12_b" style="margin-top: 10px;">
                        <tr>
                            ...
                            <td width="38%">
                                <label>
                                    <input name="sbbVo['jsje']" type="text" value="33" onblur="return jsjeChange();">
                                </label>
                            </td>
                            <td width="36%">&nbsp;</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td><label id="lblSlText">0.0005</label>
        <input name="sysl" type="hidden" value="0.0005">
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td>
                                <input name="sbbVo['bqynse']" type="text" value="0.02" onchange="return ynseChange();" readonly="readonly">
                            </td>
                ...
                <td>
                    <table width="100%" border="0" class="border h12_b" style="margin-top: 10px;">
                        <tr>
                            ...
                            <td width="2%">&nbsp;</td>
                            <td width="38%">
                                <input name="sbbVo['jmse']" type="text" value="0" onchange="jmeChange()">
                            </td>
                            <td width="36%">&nbsp;</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td>
                                <input name="sbbVo['bqybtse']" type="text" readonly="readonly" value="0"></td>
                    ...
                    <div align="center">
                        ...
                        <input type="button" id="btnQrtj" value="确认添加">
                        <input type="button" onclick="modifyBack()" value="上一步">




                        <input type="button" onclick="modifyBack()" value="取消添加">
                    </div>
                </td>
            </table>
            <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top: 30px;">
    ...
    <script type="text/javascript">
        ...
        function del(obj){
            if(confirm("是否删除 ？")){
                location.href="/jsdzsb/yhssb/submitSbb.aspx?delete=ture&xh="+xh;
            }
        }
