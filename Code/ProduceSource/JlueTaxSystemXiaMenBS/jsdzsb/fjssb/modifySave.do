       ...
       <table border="1" cellspacing="0" cellpadding="0" width="100%">
            <tr>
                  ...
                  <td colspan="2"><p align="left">2018-09-30</p> <input  type="hidden" name="sbbVo['skssqz']" value="2018-09-30"/></td>
                   <input  type="hidden" name="sbbVo['tbrq']" value="2018-09-29"/>
                    <input  type="hidden" name="sbbVo['slrq']" value=""/>
                </tr>
            <tr>
...
居民身份证&nbsp;</p></td>
            ...
            <tr>
              ...
              <a href="#" onclick="modify('ff2784f5d2784c8294bf6627b6438cc5')" >修改</a>&nbsp;&nbsp;
              
              
              <a href="#"  onclick="del('ff2784f5d2784c8294bf6627b6438cc5')">删除</a>
...
市区（增值税附征）</td>
              ...
              <td colspan="2" valign="top"><div align="right">50.00</div> 
              <input type="hidden" name="sbbList[0]['jme']"  value="50.00"/></td>
              <td colspan="2" valign="top"><div align="right">0.00</div>
              <input type="hidden" name="sbbList[0]['bqyjse']"  value="0.00"/></td>
              <td valign="top" class="blue"><div align="right">650.00</div>
              <input type="hidden" name="sbbList[0]['bqybtse']"  value="650.00"/></td>
            </tr>
    ...
    <tr><td width="24%"><div align="right" class="hintText">
	  ...
	  <td><table width="960" border="0" class="border h12_b" style="margin-top:10px;overflow: hidden">
		  ...
		  <tr>
			...
			<td width="2%">&nbsp;</td>
			<td width="38%" style="overflow: hidden"> <input name="sbbVo['jme']" type="text" value="50.00" onchange="jmeChange()" ></td>
			<td width="36%">&nbsp;</td>
		  </tr>
		  <tr>
...
>
		...
		<option value="0007129999" >0007129999|黄金交易所会员单位免征城市维护建设税|其他</option>
		  ...
		  <tr>
			...
			<td>&nbsp;</td>
			<td><input name="sbbVo['bqybtse']" type="text" value="650.00"  readonly="" ></td>
		  ...
		  <input type="hidden" name="sbbVo['yyqzdje']"  />
		   ...
		   <input type="hidden" name="xh"  value="f0960ab546474e89a4577c0384a86199" />
      </table>
			<div align="center">
