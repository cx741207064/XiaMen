<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lb.aspx.cs" Inherits="JlueTaxSystemXiaMenBS.jsdzsb.fjssb.lb1" %>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <script type="text/javascript">
        ...
        function tjsbb(){
            $("#myForm1").attr("action","/jsdzsb/fjssb/tjsblb.aspx");
            $("#myForm1").submit();
        }
        function tjsbbsb(){
            /*
                    ...
                    <td>
                        <table border="1" cellspacing="0" cellpadding="0" width="100%">
                            <tr>
                                ...
                                <input type="hidden" name="sbbVo['tbrq']" value="2018-09-05" />
                                <input type="hidden" name="sbbVo['slrq']" value="2018-09-05" />
                            </tr>
                            <tr>
