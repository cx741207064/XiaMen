...
<form action="/jsdzsb/fjssb/lb.do"  method="post"  id="myForm">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><table width="660" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:30px;">
      <tr>
      ...
      <tr>
        <td><table width="100%" cellpadding="0" cellspacing="0" class="border h12_b" style="margin-top:10px;">
          <tr>
            <td valign="bottom" class="h12_bold" style="padding-left:20px; padding-top:6px;">纳税人信息</td>
            </tr>
          <tr>
            <td style="padding-left:20px;" ><table width="100%" cellspacing="0" cellpadding="0" style=" margin-bottom:6px;">
              <tr>
                <td width="100" align="left">纳税人识别号：</td>
                <td align="left"  style="padding-left:20px;" >91350200MA2Y10EC4K</td>
              </tr>
              <tr>
                <td align="left">纳税人名称：</td>
                <td align="left"  style="padding-left:20px;" >威纳仕（厦门）酒业有限公司</td>
              </tr>
            </table></td>
            </tr>
            ...
            <td style="padding-left:20px;" ><table width="100%" cellspacing="0" cellpadding="0" style=" margin-bottom:6px;">
                <tr>
                  ...
                  <td align="left"  style="padding-left:20px;" >
                     ...
                     <input type="text" id="skssqq" value="2018-08" style="height: 24px;line-height: 24px;" xf-format="yyyy-MM" onblur="checkSkssq()" class="xf-datetime"//>
                        		
                  </td>
                  <td align="left"    style="padding-left:20px;"  class="h12_gray" >
                  <input name="sbqx" id="radOne" type="radio"  value="1"   onclick="checkSbqx()"/> 月报 &nbsp;&nbsp;
                   <input name="sbqx"  id="radTwo" type="radio"  value="2" onclick="checkSbqx()"/> 季报 &nbsp;&nbsp;
