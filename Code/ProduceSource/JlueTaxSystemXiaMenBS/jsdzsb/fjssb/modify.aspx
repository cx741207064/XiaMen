<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="modify.aspx.cs" Inherits="JlueTaxSystemXiaMenBS.jsdzsb.fjssb.modify" %>
      ...
      <tr>
       ...
       <table border="1" cellspacing="0" cellpadding="0" width="100%">
            <tr>
                  ...
                  <td colspan="4"><p align="left">2018-09-01</p>
                             <input  type="hidden" name="sbbVo['skssqq']" value="2018-09-01"/>
                  </td>
                  <td colspan="4"><p align="left">税款所属期止 </p></td>
                  <td colspan="2"><p align="left">2018-09-30</p> <input  type="hidden" name="sbbVo['skssqz']" value="2018-09-30"/></td>
                   <input  type="hidden" name="sbbVo['tbrq']" value="2018-09-26"/>
                    <input  type="hidden" name="sbbVo['slrq']" value="2018-09-26"/>
                </tr>
            <tr>
              <td colspan="3" rowspan="3" valign="top"><p>纳税人信息 </p></td>
              <td colspan="2" valign="top"><p>名称 </p></td>
              <td colspan="11" valign="top"><p></p></td>
...
居民身份证&nbsp;</p></td>
            ...
            <tr>
              ...
              <td colspan="6" valign="top"><p></p></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <a href="#" onclick="modify('79c368768a5a43798bd461d0be0f9382')" >修改</a>&nbsp;&nbsp;
              
              
              <a href="#"  onclick="del('79c368768a5a43798bd461d0be0f9382')">删除</a>
...
增值税教育费附加</td>
              ...
              <td colspan="2" valign="top"><div align="right">300.00</div>
                <input type="hidden" name="sbbList[1]['bqynse']"  value="300.00"/>
              </td>
              <td valign="top"><div align="right">
...
0061042802|按月纳税的月销售额或营业额不超过10万元缴纳义务人免征教育费附加|《财政部 国家税务总局关于扩大有关政府性基金免征范围的通知》 财税〔2016〕12号第一条
              ...
              <td colspan="2" valign="top"><div align="right">300.00</div> 
              <input type="hidden" name="sbbList[1]['jme']"  value="300.00"/></td>
              <td colspan="2" valign="top"><div align="right">0.00</div>
              <input type="hidden" name="sbbList[1]['bqyjse']"  value="0.00"/></td>
              <td valign="top" class="blue"><div align="right">0.00</div>
              <input type="hidden" name="sbbList[1]['bqybtse']"  value="0.00"/></td>
            </tr>
...
增值税地方教育附加</td>
              ...
              <td colspan="2" valign="top"><div align="right">200.00</div>
                <input type="hidden" name="sbbList[2]['bqynse']"  value="200.00"/>
              </td>
              <td valign="top"><div align="right">
...
0061042802|按月纳税的月销售额或营业额不超过10万元缴纳义务人免征教育费附加|《财政部 国家税务总局关于扩大有关政府性基金免征范围的通知》 财税〔2016〕12号第一条
              ...
              <td colspan="2" valign="top"><div align="right">200.00</div> 
              <input type="hidden" name="sbbList[2]['jme']"  value="200.00"/></td>
              <td colspan="2" valign="top"><div align="right">0.00</div>
          ...
          <input type="hidden" name="tmp_count" value="3" />
           <tr>
            ...
            <tr>
              ...
              <td colspan="5" valign="top"><p>2018-09-26&nbsp;</p></td>
	...
	<td><table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:30px;">
      ...
      <td><table width="100%" border="0" class="border h12_b" style="margin-top:10px;">
		  <tr>
			...
			<td width="28">&nbsp;</td>
			<td width="212">2018-09-01
			<input  type="hidden" name="sbbVo['skssqq']" value="2018-09-01"/>
			<input  type="hidden" name="sbbVo['skssqz']" value="2018-09-30"/>
...
<select onchange="if(relSelect) {relSelect.selectChanged(this);}"  id="sbbVo['zsxmDm']" name="sbbVo['zsxmDm']" childObjID="sbbVo['zspmDm']" blankOption=",--请选择--" dataArray="JS_ZSXM_DM" defaultID="10109">
<script type="text/javascript" language="javascript">
  ...
  <option value="10109" selected>城市维护建设税</option>
...
<script type="text/javascript" language="javascript">
  ...
  <option value="101090101" selected>市区（增值税附征）</option>
...
<select runat="server" id="_combobox_" name="sbbVo['zzsxselx_dm']" 
	style="" 
...
城市维护建设税
                        <input type="hidden" name="sbbVo['zsxmDm']" value="10109"/>
			</td>
...
市区（增值税附征）
      ...
      <td width="2%">&nbsp;</td>
      <td width="38%"><label>
      <asp:Label runat="server" ID="lblxse">月销售额合计10万（含）以下</asp:Label>
         <input name="sbbVo['zzsxselx_dm']"  id="ZZSXSELX_DM" type="hidden" value="<%=ZzsXseDm%>" >
         <input name="sbbVo['xshjs']" type="hidden" value=""<%=xshjs%>"" >
         <input name="xshjs" type="hidden" value=""<%=sbbVo_xshjs %>"" >
      </label></td>
    ...
    <tr><td width="24%"><div align="right" class="hintText">
      ...
      <td width="2%">&nbsp;</td>
      <td width="38%"><label>
        <input name="sbbVo['ybzzs']" type="text" value="<%=ybzzs%>" onblur="return sdeChange();">
      </label></td>
      <td width="36%">&nbsp;</td>
      </tr>
      <tr>
      ...
      <td>&nbsp;</td>
      <td><label>
       <input name="sbbVo['zzsmdse']" type="text" value="<%=zzsmdse%>" onblur="return sdeChange();">
      </label></td>
      <td>&nbsp;</td>
      </tr>
      <tr>
      ...
      <td>&nbsp;</td>
      <td><input name="sbbVo['xfs']" type="text" value="<%=xfs%>" onblur="return sdeChange();"></td>
      <td>&nbsp;</td>
      </tr>
      ...
      <tr>
        ...
        <td>&nbsp;</td>
        <td><input name="sbbVo['yys']" type="text" value="<%=yys%>" onblur="return sdeChange();"> </td>
        <td>&nbsp;</td>
        </tr>
      <tr>
        <td><div align="right"><span class="STYLE1 STYLE4">*</span>合计：</div></td>
        <td>&nbsp;</td>
        <td><input name="sbbVo['hj']" type="text" value="<%=hj%>" readonly="readonly">&nbsp;</td>
      ...
      <td>&nbsp;</td>
      <td><input name="sbbVo['bqynse']" type="text" value="<%=bqynse%>" readonly="readonly" onchange="calcSjjne()">&nbsp;&nbsp;</td>
      <td><span class="STYLE3">自动计算</span></td>  
        </tr> 
    </table></td>
	  <tr></tr>
	  <td><table width="960" border="0" class="border h12_b" style="margin-top:10px;overflow: hidden">
		  ...
		  <tr>
			...
			<td width="2%">&nbsp;</td>
			<td width="38%" style="overflow: hidden"> <input name="sbbVo['jme']" type="text" value="<%=jme%>" onchange="jmeChange()" ></td>
			<td width="36%">&nbsp;</td>
		  </tr>
		  <tr>
...
>
		...
		<option value="0007129999" >0007129999|黄金交易所会员单位免征城市维护建设税|其他</option>
		  ...
		  <tr>
			...
			<td>&nbsp;</td>
			<td ><input name="sbbVo['bqyjse']"  type="text" value="<%=bqyjse%>" onblur="yjeChange()"></td>
			<td>&nbsp;</td>
		  </tr>
		  ...
		  <tr>
			...
			<td>&nbsp;</td>
			<td ><input name="sbbVo['jyffjyjse']" readonly="readonly" disabled="disabled" type="text" value="<%=jyffjyjse%>"  onchange="jyyjeChange()"></td>
			<td>&nbsp;</td>
		  </tr>
		  ...
		  <tr>
			...
			<td>&nbsp;</td>
			<td ><input name="sbbVo['dffjjyjse']" readonly="readonly" disabled="disabled" type="text" value="<%=dffjjyjse%>" onchange="dfjyyjeChange()"></td>
			<td>&nbsp;</td>
		  </tr>
		  ...
		  <tr>
			...
			<td>&nbsp;</td>
			<td><input name="sbbVo['bqybtse']" type="text" value="<%=bqybtse%>"  readonly="" ></td>
		  ...
		  <input type="hidden" name="sbbVo['yyqzdje']"  />
		   ...
		   <input type="hidden" name="xh"  value="79c368768a5a43798bd461d0be0f9382" />
      </table>
			<div align="center">
			   
       
        <input  type="button" onClick="qrtj('modify')" value="确认修改" >
         <input  type="button" onClick="location.href='/jsdzsb/fjssb/lb.aspx'" value="上一步">
       
       
      
      		
		   
			<input  type="button" onClick="location.href='/jsdzsb/fjssb/lb.aspx'" value="取消添加" >
			</div>
		</td>
	</table>
