<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="txsbb.aspx.cs" Inherits="JlueTaxSystemXiaMenBS.jsdzsb.fjssb.txsbb" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        function qrtj(flag){
            ...
            var  zzsxselx_dm  =getObj("ZZSXSELX_DM").value;
            if(hj==""  ){
                            ...
                            <td width="212">
                                <label>
                                    ...
                                    <select runat="server" id="_combobox_" name="sbbVo['zzsxselx_dm']"
                                        ...
                                        <option value="13" selected>月销售额合计数为10万以上</option>
	  ...
	  <tr></tr>
              ...
              <input type="hidden" name="sbbVo['zspmDm']" value="101090101" />
                                ...
                                <tr>
                                    ...
                                    <td width="38%">
                                        <label>
                                       <asp:Label runat="server" ID="lblxse">月销售额合计数为10万以上</asp:Label>
		...
		<option value="0007129999" >0007129999|黄金交易所会员单位免征城市维护建设税|其他</option>
			 ...
			 -->
                ...
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td>
                        <input name="sbbVo['jyffjyjse']" type="text" value="" onchange="jyyjeChange()"></td>
                    <td>&nbsp;</td>
                </tr>
		  ...
		  <tr>
              ...
              <td>&nbsp;</td>
              <td>
                  <input name="sbbVo['dffjjyjse']" type="text" value="" onchange="dfjyyjeChange()"></td>
              <td>&nbsp;</td>
          </tr>
