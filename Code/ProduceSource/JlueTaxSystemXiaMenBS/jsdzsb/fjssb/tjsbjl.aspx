<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tjsbjl.aspx.cs" Inherits="JlueTaxSystemXiaMenBS.jsdzsb.fjssb.tjsbjl" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        function isErr() {
            var err = document.getElementById("isErr").getAttribute("value");
            if(err == "yes")
            {
        ...
        function txsbb(){
            ...
            if(xgbz=="yes")
                ...
                $("#myForm2").attr("action","/jsdzsb/fjssb/txsbb.aspx");
            $("#myForm2").submit();
            /*
    ...
    <div id='yhssblb'>
        <form action="/jsdzsb/yhssb/lb.do" method="post" id="myForm1">
            ...
            <input type="hidden" name="isErr" id="isErr" value="no" runat="server">
                    ...
                    <td>
                        <table border="1" cellspacing="0" cellpadding="0" width="100%">
                            <tr>
                                ...
                                <td colspan="2">
                                    <p align="left">91350200MA2Y10EC4K</p>
                                </td>
                                <td colspan="7">
                                    <p align="left">税款所属期起 </p>
                                </td>
                                <td colspan="4">
                                    <p align="left">2018-08-01</p>
                                ...
                                <td colspan="2">
                                    <p align="left">2018-08-31</p>
                                    <input type="hidden" name="sbbVo['skssqz']" value="2018-08-31" /></td>
...
<!--
    ...
    //-->
                        ...
                        <tr>
                            <td class="hintText">
                                <div align="right"><span class="STYLE1 STYLE4">*</span>征收品目：</div>
                            </td>
                            <td>&nbsp;</td>
                            <td>
                                <label>
    ...
    <div id="yhstxsbb">
        <form action="/jsdzsb/yhssb/lb.do" method="post" id="myForm3">
            ...
            <input type="hidden" name="nsqx_dm" value="06" />
            <input type="hidden" name="xms" value="10109" />
            <input type="hidden" name="tenwjmFlag" value="" />
            <input type="hidden" name="threewjmFlag" value="" />
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="gray_bg_color">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin-bottom: 8px; margin-top: 8px;">
	  ...
	  <tr></tr>
                                ...
                                <tr>
                                    ...
                                    <td width="38%">
                                        <label>
                                            ...
                                            <input name="sbbVo['zzsxselx_dm']" id="ZZSXSELX_DM" type="hidden" value="">
                        ...
                        <td>
                            <table width="100%" border="0" class="border h12_b" style="margin-top: 10px;">
                                ...
                                <tr>
                                    <td>
                                        <div align="right" id="zzs_mdse">增值税（免抵税额）：</div>
                                    </td>
                                    <td>&nbsp;</td>
                                    <td>
                                        <label>
                                ...
                                <tr>
                                    <td>
                                        <div align="right" id="xfs"><span class="STYLE1 STYLE4">*</span>消费税：</div>
                                    </td>
                                    <td>&nbsp;</td>
                                    <td>
                                        <input name="sbbVo['xfs']" type="text" value="" onblur="return sdeChange();"></td>
                                    <td>&nbsp;</td>
                                </tr>

                                <tr>
                                    <td>
                                        <div align="right" id="yys"><span class="STYLE1 STYLE4">*</span>营业税：</div>
                                    </td>
                                    <td>&nbsp;</td>
                                    <td>
                                        <input name="sbbVo['yys']" type="text" value="" onblur="return sdeChange();">
                                    </td>
                                    <td>&nbsp;</td>
                                </tr>
                                <tr>
                                    <td>
                                        <div align="right"><span class="STYLE1 STYLE4">*</span>合计：</div>
                                    </td>
                                    <td>&nbsp;</td>
                                    <td>
                                        <input name="sbbVo['hj']" type="text" value="" readonly="readonly">&nbsp;</td>
                                ...
                                <tr>
                                    <td>
                                        <div align="right"><span class="hintText"><span class="STYLE1 STYLE4">*</span>本期应纳税（费）额</span>：</div>
                                    </td>
                                    <td>&nbsp;</td>
                                    <td>
                                        <input name="sbbVo['bqynse']" type="text" value="" readonly="readonly" onchange="calcSjjne()">&nbsp;&nbsp;</td>
                                    <td><span class="STYLE3">自动计算</span></td>
                                </tr>
                            </table>
                        </td>
                        <tr></tr>
                        <td>
                            <table width="960" border="0" class="border h12_b" style="margin-top: 10px; overflow: hidden">

                                <tr>
                                    <td width="24%">
                                        <div align="right">本期减免税（费）额：</div>
                                    </td>
                                    <td width="2%">&nbsp;</td>
                                    <td width="38%" style="overflow: hidden">
                                        <input name="sbbVo['jme']" type="text" value="" onchange="jmeChange()"></td>
                                    <td width="36%">&nbsp;</td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div align="right">本期已缴税（费）额：</div>
                                    </td>
                                    <td>&nbsp;</td>
                                    <td>
                                        <input name="sbbVo['bqyjse']" type="text" value="" onblur="yjeChange()"></td>
                                    <td>&nbsp;</td>
                                </tr>
                </tr>
                <tr>
                    <td>
                        <div align="right">教育费附加已缴税（费）额：</div>
                    </td>
                    <td>&nbsp;</td>
                    <td>
                        <input name="sbbVo['jyffjyjse']" readonly="readonly" disabled="disabled" type="text" value="" onchange="jyyjeChange()"></td>
                    <td>&nbsp;</td>
                </tr>
		  ...
		  <tr>
              <td>
                  <div align="right">地方教育附加已缴税（费）额：</div>
              </td>
              <td>&nbsp;</td>
              <td>
                  <input name="sbbVo['dffjjyjse']" readonly="readonly" disabled="disabled" type="text" value="" onchange="dfjyyjeChange()"></td>
              <td>&nbsp;</td>
          </tr>
                ...
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td>
                        <input name="sbbVo['bqybtse']" type="text" value="" readonly=""></td>
                    <td><span class="STYLE3">=本期应纳税额-本期减免税额-本期已缴税额</span></td>
                </tr>
                <input type="hidden" name="sbbVo['sffjjm']" value="" />
            ...
            <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top: 30px;">
                <tr>
                    <td valign="top" bgcolor="#EFF4FC" style="line-height: 1.5; color: red">
                        <p>
                            说明：
            &nbsp;&nbsp;&nbsp;&nbsp;1、红色*号必须填写；<br />
