<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="submitSbb_java.aspx.cs" Inherits="JlueTaxSystemXiaMenBS.jsdzsb.fjssb.submitSbb_java" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td>
      ...
      <tr>
        <td align="center" class="h16_bold"><p>城建税、教育费附加、地方教育附加税（费）申报表</p>
          </td>
      </tr><td>
       <table border="1" cellspacing="0" cellpadding="0" width="100%">
            <tr>
                  <td colspan="3"><p align="left">纳税人识别号 </p></td>
                  <td colspan="2"><p align="left">91350200MA2Y10EC4K</p></td>
                  <td colspan="7"><p align="left">税款所属期起 </p></td>
                  <td colspan="4"><p align="left">2018-10-01</p>
                             <input  type="hidden" name="sbbVo['skssqq']" value="2018-10-01"/>
                  </td>
                  <td colspan="4"><p align="left">税款所属期止 </p></td>
                  <td colspan="2"><p align="left">2018-10-31</p> <input  type="hidden" name="sbbVo['skssqz']" value="2018-10-31"/></td>
                   <input  type="hidden" name="sbbVo['tbrq']" value="2018-10-18"/>
                    <input  type="hidden" name="sbbVo['slrq']" value="2018-10-18"/>
                </tr>
            <tr>
              <td colspan="3" rowspan="3" valign="top"><p>纳税人信息 </p></td>
              <td colspan="2" valign="top"><p>名称 </p></td>
              <td colspan="11" valign="top"><p>威纳仕（厦门）酒业有限公司</p></td>
              <td colspan="4" valign="top"><p>登记类型 </p></td>
            ...
            <tr>
              <td colspan="2" valign="top"><p>登记注册类型 </p></td>
...
其他有限责任公司</p></td>
              <td colspan="4" valign="top"><p>所属行业 </p></td>
...
酒、饮料及茶叶批发</p></td>
              <td colspan="3" valign="top"><p>身份证件类型 </p></td>
              <td colspan="4" valign="top"><p>
...
居民身份证&nbsp;</p></td>
            ...
            <tr>
              <td colspan="2" valign="top"><p>身份证件号码 </p></td>
              <td colspan="9" valign="top"><p>350583198410020798&nbsp;</p></td>
              <td colspan="2" valign="top"><p>联系方式 </p></td>
              <td colspan="6" valign="top"><p>18559796088&nbsp;</p></td>
            </tr>
            <tr>
              <td width="68" rowspan="3" valign="top"><div align="center">操作</div></td>
              <td width="55" rowspan="3" valign="top">征收项目</td>
              <td width="69" rowspan="3" valign="top">征收品目</td>
              <td colspan="8" valign="top"><p align="center">计税（费）依据 </p></td>
              <td colspan="3" rowspan="3" valign="top"><p align="center">税率（征收率） </p></td>
              <td colspan="2" rowspan="3" valign="top"><p align="center">本期应纳税（费）额 </p></td>
              <td colspan="3" rowspan="2" valign="top"><p align="center">本期减免税（费）额 </p></td>
              <td colspan="2" rowspan="3" valign="top"><p align="center">本期已缴税（费）额 </p></td>
              <td width="154" rowspan="3" valign="top" style="color:Maroon"><p align="center" >本期应补（退）税（费）额 </p></td>
            </tr>
            <tr>
              <td colspan="3" valign="top"><p align="center">增值税 </p></td>
              <td colspan="2" rowspan="2" valign="top"><p>消费税 </p></td>
              <td colspan="2" rowspan="2" valign="top"><p>营业税 </p></td>
              <td width="105" rowspan="2" valign="top"><p>合计 </p></td>
            </tr>
            <tr>
              <td width="104" valign="top"><p>一般增值税 </p></td>
              <td colspan="2" valign="top"><p>免抵税额 </p></td>
              <td width="105" valign="top"><p align="center">减免性质代码 </p></td>
              <td colspan="2" valign="top"><p align="center">减免额 </p></td>
            </tr>
              ...
              <a href="#" onclick="modify('f3fe3f95e0f449729bc26a0bb4fa055e')" >修改</a>&nbsp;&nbsp;
              
              
              <a href="#"  onclick="del('f3fe3f95e0f449729bc26a0bb4fa055e')">删除</a>
              
              &nbsp;&nbsp;</td>
              <input type="hidden" value="13BDA04105BBF3976BD13F5B0F923B39" />
              <td nowrap >
...
市区（增值税附征）</td>
              <td valign="top"><div align="right">  10000.00</div>
               <input type="hidden" name="sbbList[0]['ybzzs']"  value="10000.00"/>
              </td>
              <td colspan="2" valign="top"><div align="right">0.00</div>
              ...
              <td valign="top"><div align="right">10000.00</div>
                 <input type="hidden" name="sbbList[0]['hj']"  value="10000.00"/>
              </td>
              <td colspan="3" valign="top"><div align="right">0.07</div></td>
              <td colspan="2" valign="top"><div align="right">700.00</div>
                <input type="hidden" name="sbbList[0]['bqynse']"  value="700.00"/>
              </td>
              ...
              <td valign="top" class="blue"><div align="right">700.00</div>
              <input type="hidden" name="sbbList[0]['bqybtse']"  value="700.00"/></td>
            </tr>
              ...
              <a href="#" onclick="modify('2191aebe051146359df6534e0a44f266')" >修改</a>&nbsp;&nbsp;
              
              
              <a href="#"  onclick="del('2191aebe051146359df6534e0a44f266')">删除</a>
...
市区（增值税附征）</td>
              <td valign="top"><div align="right">  10000.00</div>
               <input type="hidden" name="sbbList[1]['ybzzs']"  value="10000.00"/>
              </td>
              <td colspan="2" valign="top"><div align="right">0.00</div>
              ...
              <td valign="top"><div align="right">10000.00</div>
                 <input type="hidden" name="sbbList[1]['hj']"  value="10000.00"/>
              </td>
              <td colspan="3" valign="top"><div align="right">0.07</div></td>
              <td colspan="2" valign="top"><div align="right">700.00</div>
                <input type="hidden" name="sbbList[1]['bqynse']"  value="700.00"/>
              </td>
              <td valign="top"><div align="right">
	               <!---->
              ...
              <td valign="top" class="blue"><div align="right">700.00</div>
              <input type="hidden" name="sbbList[1]['bqybtse']"  value="700.00"/></td>
            </tr>
...
增值税教育费附加</td>
              <td valign="top"><div align="right">  10000.00</div>
               <input type="hidden" name="sbbList[2]['ybzzs']"  value="10000.00"/>
              </td>
              <td colspan="2" valign="top"><div align="right">0.00</div>
              ...
              <td valign="top"><div align="right">10000.00</div>
                 <input type="hidden" name="sbbList[2]['hj']"  value="10000.00"/>
              </td>
              <td colspan="3" valign="top"><div align="right">0.03</div></td>
              <td colspan="2" valign="top"><div align="right">300.00</div>
                <input type="hidden" name="sbbList[2]['bqynse']"  value="300.00"/>
              </td>
              <td valign="top"><div align="right">
	               <!---->
...
0061042802|按月纳税的月销售额或营业额不超过10万元缴纳义务人免征教育费附加|《财政部 国家税务总局关于扩大有关政府性基金免征范围的通知》 财税〔2016〕12号第一条
              </div></td>
              <td colspan="2" valign="top"><div align="right">300.00</div> 
              <input type="hidden" name="sbbList[2]['jme']"  value="300.00"/></td>
              <td colspan="2" valign="top"><div align="right">0.00</div>
              <input type="hidden" name="sbbList[2]['bqyjse']"  value="0.00"/></td>
              <td valign="top" class="blue"><div align="right">0.00</div>
              <input type="hidden" name="sbbList[2]['bqybtse']"  value="0.00"/></td>
            </tr>
...
增值税地方教育附加</td>
              <td valign="top"><div align="right">  10000.00</div>
               <input type="hidden" name="sbbList[3]['ybzzs']"  value="10000.00"/>
              </td>
              <td colspan="2" valign="top"><div align="right">0.00</div>
               <input type="hidden" name="sbbList[3]['zzsmdse']"  value="0.00"/>
              </td>
              <td colspan="2" valign="top"><div align="right">0.00</div>
              <input type="hidden" name="sbbList[3]['xfs']"  value="0.00"/>
              </td>
              <td colspan="2" valign="top"><div align="right">0.00</div>
              <input type="hidden" name="sbbList[3]['yys']"  value="0.00"/>
               </td>
              <td valign="top"><div align="right">10000.00</div>
                 <input type="hidden" name="sbbList[3]['hj']"  value="10000.00"/>
              </td>
              <td colspan="3" valign="top"><div align="right">0.02</div></td>
              <td colspan="2" valign="top"><div align="right">200.00</div>
                <input type="hidden" name="sbbList[3]['bqynse']"  value="200.00"/>
              </td>
              <td valign="top"><div align="right">
	               <!---->
...
0061042802|按月纳税的月销售额或营业额不超过10万元缴纳义务人免征教育费附加|《财政部 国家税务总局关于扩大有关政府性基金免征范围的通知》 财税〔2016〕12号第一条
              ...
              <td colspan="2" valign="top"><div align="right">200.00</div> 
              <input type="hidden" name="sbbList[3]['jme']"  value="200.00"/></td>
              <td colspan="2" valign="top"><div align="right">0.00</div>
              <input type="hidden" name="sbbList[3]['bqyjse']"  value="0.00"/></td>
              <td valign="top" class="blue"><div align="right">0.00</div>
              <input type="hidden" name="sbbList[3]['bqybtse']"  value="0.00"/></td>
            </tr>
...
增值税教育费附加</td>
              <td valign="top"><div align="right">  10000.00</div>
               <input type="hidden" name="sbbList[4]['ybzzs']"  value="10000.00"/>
              </td>
              <td colspan="2" valign="top"><div align="right">0.00</div>
               <input type="hidden" name="sbbList[4]['zzsmdse']"  value="0.00"/>
              </td>
              <td colspan="2" valign="top"><div align="right">0.00</div>
              <input type="hidden" name="sbbList[4]['xfs']"  value="0.00"/>
              </td>
              <td colspan="2" valign="top"><div align="right">0.00</div>
              <input type="hidden" name="sbbList[4]['yys']"  value="0.00"/>
               </td>
              <td valign="top"><div align="right">10000.00</div>
                 <input type="hidden" name="sbbList[4]['hj']"  value="10000.00"/>
              </td>
              <td colspan="3" valign="top"><div align="right">0.03</div></td>
              <td colspan="2" valign="top"><div align="right">300.00</div>
                <input type="hidden" name="sbbList[4]['bqynse']"  value="300.00"/>
              </td>
              <td valign="top"><div align="right">
	               <!---->
...
0061042802|按月纳税的月销售额或营业额不超过10万元缴纳义务人免征教育费附加|《财政部 国家税务总局关于扩大有关政府性基金免征范围的通知》 财税〔2016〕12号第一条
              ...
              <td colspan="2" valign="top"><div align="right">300.00</div> 
              <input type="hidden" name="sbbList[4]['jme']"  value="300.00"/></td>
              <td colspan="2" valign="top"><div align="right">0.00</div>
              <input type="hidden" name="sbbList[4]['bqyjse']"  value="0.00"/></td>
              <td valign="top" class="blue"><div align="right">0.00</div>
              <input type="hidden" name="sbbList[4]['bqybtse']"  value="0.00"/></td>
            </tr>
...
增值税地方教育附加</td>
              <td valign="top"><div align="right">  10000.00</div>
               <input type="hidden" name="sbbList[5]['ybzzs']"  value="10000.00"/>
              </td>
              <td colspan="2" valign="top"><div align="right">0.00</div>
               <input type="hidden" name="sbbList[5]['zzsmdse']"  value="0.00"/>
              </td>
              <td colspan="2" valign="top"><div align="right">0.00</div>
              <input type="hidden" name="sbbList[5]['xfs']"  value="0.00"/>
              </td>
              <td colspan="2" valign="top"><div align="right">0.00</div>
              <input type="hidden" name="sbbList[5]['yys']"  value="0.00"/>
               </td>
              <td valign="top"><div align="right">10000.00</div>
                 <input type="hidden" name="sbbList[5]['hj']"  value="10000.00"/>
              </td>
              <td colspan="3" valign="top"><div align="right">0.02</div></td>
              <td colspan="2" valign="top"><div align="right">200.00</div>
                <input type="hidden" name="sbbList[5]['bqynse']"  value="200.00"/>
              </td>
              <td valign="top"><div align="right">
	               <!---->
...
0061042802|按月纳税的月销售额或营业额不超过10万元缴纳义务人免征教育费附加|《财政部 国家税务总局关于扩大有关政府性基金免征范围的通知》 财税〔2016〕12号第一条
              ...
              <td colspan="2" valign="top"><div align="right">200.00</div> 
              <input type="hidden" name="sbbList[5]['jme']"  value="200.00"/></td>
              <td colspan="2" valign="top"><div align="right">0.00</div>
              <input type="hidden" name="sbbList[5]['bqyjse']"  value="0.00"/></td>
              <td valign="top" class="blue"><div align="right">0.00</div>
              <input type="hidden" name="sbbList[5]['bqybtse']"  value="0.00"/></td>
            </tr>
            
           
          
          <input type="hidden" name="tmp_count" value="6" />
           <tr>
              <td colspan="3" valign="top">合计</td>
              <td valign="top"><div align="right" id="_ybzzs"></div>&nbsp; </td>
              <td colspan="2" valign="top"><div align="right" id="_zzsmdse"></div>&nbsp;</td>
              <td colspan="2" valign="top"><div align="right" id="_xfs"></div></td>
              <td colspan="2" valign="top"><div align="right" id="_yys"></div>&nbsp;</td>
              <td valign="top"><div align="right" id="_hj"></div></td>
              <td colspan="3" valign="top">— </td>
              <td colspan="2" valign="top"><div align="right" id="_bqynse"></div></td>
              <td valign="top">— </td>
              <td colspan="2" valign="top"><div align="right" id="_jme"></div>&nbsp;</td>
              <td colspan="2" valign="top"><div align="right" id="_bqyjse"></div>&nbsp;</td>
              <td valign="top"  ><div align="right" id="_bqybtse" style="color:red;"></div></td>
            </tr>
            <tr>
              <td colspan="3" valign="top"><p>代理人 </p></td>
              <td colspan="8" valign="top"><p>王德霖&nbsp;</p></td>
              <td colspan="5" valign="top"><p>代理人身份证号 </p></td>
              <td colspan="6" valign="top"><p>350583198410020798&nbsp;</p></td>
            </tr>
            <tr>
              <td colspan="3" valign="top"><p>受理人</p></td>
              <td colspan="4" valign="top"><p>王德霖&nbsp;</p></td>
              <td colspan="4" valign="top"><p>受理日期 </p></td>
              <td colspan="5" valign="top"><p>2018-10-18&nbsp;</p></td>
              <td colspan="3" valign="top"><p>受理税务机关 </p></td>
...
<input type="hidden" name="xms" value="10109" />
  ...
  <tr>
	<td><table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:30px;">
	  ...
	  <td><table width="100%" border="0" class="border h12_b" style="margin-top:10px;">
     <tr>
      <td width="183"><div align="right" class="hintText">
...
<script type="text/javascript" language="javascript">
  ...
  <option value="10109" >城市维护建设税</option>
      ...
      <tr>
      <td class="hintText"><div align="right"><span class="STYLE1 STYLE4">*</span>征收品目：</div></td>
      <td>&nbsp;</td>
      <td><label>
...
<select onchange="if(relSelect) {relSelect.selectChanged(this);}"  id="sbbVo['zspmDm']" name="sbbVo['zspmDm']" parentObjID="sbbVo['zsxmDm']" dataArray="JS_ZSPM_DM">
<script type="text/javascript" language="javascript">
    //字段名： DM, DMZW_MC, SJDM, DM_MC
    ...
    new Array("101090101", "市区（增值税附征）", "10109", "101090101")
      ...
      <td>&nbsp;</td>
       ...
       <tr><td width="183"><div align="right" class="hintText">
        <div align="right" id="ybzzs"><span class="STYLE1 STYLE4">*</span>本月销售额合计数 
...
>
		...
		<option value="12" selected>月销售额合计10万（含）以下</option>
      ...
      <td width="357">（用于小微企业免征增值税附加税费的计算，请正确填写。）&nbsp;</td>
			...
			<div align="center">
		      ...
		      <input   type="button" onClick="location.href='/jsdzsb/fjssb/lb.do'" value="取消添加">
			</div>
		</td>
	</table></td>
  </tr>
...
<input type="hidden" name="nsqx_dm" value="06" />
<input type="hidden" name="xms" value="10109" />
<input type="hidden" name="tenwjmFlag" value="Y" />
	  ...
	  <td><table width="100%" border="0" class="border h12_b" style="margin-top:10px;">
		  <tr>
			...
			<td width="38%"> 
                        ...
                        <input type="hidden" name="sbbVo['zsxmDm']" value=""/>
			</td>
		  ...
		  <tr>
			...
			<td>
              ...
              <input type="hidden" name="sbbVo['zspmDm']" value=""/>
           </td>
			<td><label></label></td>
		  </tr>
		  <tr><td width="24%"><div align="right" class="hintText">
        <div align="right" id="Div1"><span class="STYLE1 STYLE4">*</span>本月销售额合计数 
...
月销售额合计10万（含）以下
         <input name="sbbVo['zzsxselx_dm']"  id="ZZSXSELX_DM" type="hidden" value="12" >
         <input name="sbbVo['xshjs']" type="hidden" value="17000" >
         <input name="xshjs" type="hidden" value="100000.0" >
      </label></td>
      <td width="36%">（用于小微企业免征增值税附加税费的计算。）&nbsp;</td>
      </tr>
	  ...
	  <td><table width="100%" border="0" class="border h12_b" style="margin-top:10px;">
    <tr><td width="24%"><div align="right" class="hintText">
        <div align="right" id="Div2"><span class="STYLE1 STYLE4">*</span>增值税（一般增值税）：</div>
      </div></td>
      <td width="2%">&nbsp;</td>
      <td width="38%"><label>
        <input name="sbbVo['ybzzs']" type="text" value="10000.00" onblur="return sdeChange();">
      </label></td>
      <td width="36%">&nbsp;</td>
      </tr>
      <tr>
      <td><div align="right" id="zzs_mdse">增值税（免抵税额）：</div></td>
      <td>&nbsp;</td>
      <td><label>
       <input name="sbbVo['zzsmdse']" type="text" value="0.00" onblur="return sdeChange();">
      </label></td>
      <td>&nbsp;</td>
      </tr>
      <tr>
      <td><div align="right" id="xfs"><span class="STYLE1 STYLE4">*</span>消费税：</div></td>
      <td>&nbsp;</td>
      <td><input name="sbbVo['xfs']" type="text" value="0.00" onblur="return sdeChange();"></td>
      <td>&nbsp;</td>
      </tr>
      
      <tr>
        <td><div align="right" id="yys"><span class="STYLE1 STYLE4">*</span>营业税：</div></td>
        <td>&nbsp;</td>
        <td><input name="sbbVo['yys']" type="text" value="0.00" onblur="return sdeChange();"> </td>
        <td>&nbsp;</td>
        </tr>
      <tr>
        <td><div align="right"><span class="STYLE1 STYLE4">*</span>合计：</div></td>
        <td>&nbsp;</td>
        <td><input name="sbbVo['hj']" type="text" value="10000.00" readonly="readonly">&nbsp;</td>
        <td><span class="STYLE3">自动计算</span></td>
        </tr>
      <tr>
      <td><div align="right">
        <p align="right"><span class="STYLE1 STYLE4">*</span>税率（征收率）：</p>
        </div></td>
      <td>&nbsp;</td>
      <td>0.07</td>
        <td>
       <input type="hidden" name="sbbVo['sl1']" value="0.07"  />
      </td>
      <td>&nbsp;</td>
      </tr>
      
      <tr>
      <td><div align="right"><span class="hintText"><span class="STYLE1 STYLE4">*</span>本期应纳税（费）额</span>：</div></td>
      <td>&nbsp;</td>
      <td><input name="sbbVo['bqynse']" type="text" value="700.00" readonly="readonly" onchange="calcSjjne()">&nbsp;&nbsp;</td>
      <td><span class="STYLE3">自动计算</span></td>  
        </tr> 
    </table></td>
	  <tr></tr>
	  <td><table width="960" border="0" class="border h12_b" style="margin-top:10px;overflow: hidden">
	       
		  <tr>
			<td width="24%"><div align="right">本期减免税（费）额：</div></td>
			<td width="2%">&nbsp;</td>
			<td width="38%" style="overflow: hidden"> <input name="sbbVo['jme']" type="text" value="0.00" onchange="jmeChange()" ></td>
			<td width="36%">&nbsp;</td>
		  </tr>
		  <tr>
...
<select id="_combobox_" name="sbbVo['jmxzDm']" 
...
<select id="ssjmxzdm" name="sbbVo['jmxzDm']" 
	onchange="changeSsjmxzDm()"
...
>
		...
		<option value="0007129999" >0007129999|黄金交易所会员单位免征城市维护建设税|其他</option>
			  ...
			  <!--  <input type="hidden" name="sbbVo['jmxzDmMc']" value=""/>-->
		  ...
		  <tr>
			<td><div align="right">本期已缴税（费）额：</div></td>
			<td>&nbsp;</td>
			<td ><input name="sbbVo['bqyjse']"  type="text" value="0.00" onblur="yjeChange()"></td>
			<td>&nbsp;</td>
		  </tr>
		  ...
		  <tr>
			<td><div align="right">教育费附加已缴税（费）额：</div></td>
			<td>&nbsp;</td>
			<td ><input name="sbbVo['jyffjyjse']" readonly="readonly" disabled="disabled" type="text" value=""  onchange="jyyjeChange()"></td>
			<td>&nbsp;</td>
		  </tr>

      		  </tr>
		  <tr>
			<td><div align="right"> 地方教育附加已缴税（费）额：</div></td>
			<td>&nbsp;</td>
			<td ><input name="sbbVo['dffjjyjse']" readonly="readonly" disabled="disabled" type="text" value="" onchange="dfjyyjeChange()"></td>
			<td>&nbsp;</td>
		  </tr>
		  ...
		  <tr>
			...
			<td>&nbsp;</td>
			<td><input name="sbbVo['bqybtse']" type="text" value="700.00"  readonly="" ></td>
			<td><span class="STYLE3">=本期应纳税额-本期减免税额-本期已缴税额</span></td>
		  </tr>
		  <input type="hidden" name="sbbVo['sffjjm']" value="Y"/>
		  <input type="hidden" name="sbbVo['pzxh']" value=""/>
		  <input type="hidden" name="sbbVo['sfzf']" value=""/>
		  ...
		  <input type="hidden" name="sbbVo['yyqzdje']"  />
		   <input type="hidden" name="sbbVo['rdpzuuid']" value="13BDA04105BBF3976BD13F5B0F923B39"  />
        ...
        <input  type="button" onClick="qrtj('tj')" value="确认添加" >
         <input  type="button" onClick="location.href='/jsdzsb/fjssb/lb.do'" value="上一步">
...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:30px;">
    <tr>
      <td valign="top" bgcolor="#EFF4FC" style="line-height:1.5;color:red"><p>说明：
            &nbsp;&nbsp;&nbsp;&nbsp;1、红色*号必须填写；<br/>
             
            &nbsp;&nbsp;&nbsp;&nbsp;2、减免性质代码：减免性质代码按照国家税务总局制定下发的最新《减免性质及分类表》中的最细项减免性质代码填报。<br/>
