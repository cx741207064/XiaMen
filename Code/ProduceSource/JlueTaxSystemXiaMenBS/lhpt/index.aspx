<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="JlueTaxSystemXiaMenBS.lhpt.index" %>
        ...
        <div xf-view=''>
            ...
            <div id="bsfwContainer" style="display: none">
                ...
                <div id="bsfwMenu">
                    ...
                    <ul id="bsfwMenuUl">
                        <li onclick="fMenuChanage(this,0)" index="true" class="bsfwMenuUlActive" msrc="/bsfw/home/home.aspx">首页</li>
                        <li id="ssbl_li" onclick="fMenuChanage(this,1)" msrc="/bsfw/home/ssbl_index.aspx">我要办税</li>
                        <li id="SSCX" onclick="fMenuChanage(this,2)" msrc="/bsfw/home/sscx_index.aspx">我要查询</li>
                ...
                <div id="icNav">
                    <ul id="icNavUl" style="width: 1100px;">
                        ...
                        <li class="ejcd_id_10" style="display: none;" onclick="openxzcd('SSCX','3','2')">
                            <a class="" href="javascript:void(0);" id="A1"></a>
                            <!-- <a class="abtn dark_blue ahover" href="javascript:void(0);" id="dzcd_pic_top_dark_3" style="display: none;"></a> -->
            ...
            <div class="bsfwManagerMsg" id="bsfwManagerMsg" style="display: none; width: 1200px;">
                <ul id="managerMsg">
                    <li class="managerImg">
                        <img src="/res/images/bsfwhall/bsfw_icon.png" /></li>
                    <li>您的主管税务人员：</li>
            ...
            <!--iconNavEnd-->
            <iframe id="mainFrame" name="mainFrame" src="/bsfw/home/home.aspx" frameborder="0"
