...
<script type="text/javascript">	
	...
	function moretzgg(){
    	var url="/tnsfwHome/index.do?menuid=tzgg&menu_item_id=tzgg";
				 	...
				 	<div class="box_content" > 
								...
								<table class="content_info ct" style="border-style:none;width:100%">
												...
												<!-- 有效 -->
															...
															<td class="content_infos" style="background-color: #ffffff;" onclick="window.parent.showContent('bszx_03','bszx','/tnsfwHome/index.do?menuid=bszx_03&menu_item_id=bszx_03','1','N','')">
												...
												<!-- 有效 -->
															...
															<td class="content_infos" style="background-color: #ffffff;" onclick="window.parent.showContent('bszx_09','bszx','','2','Y','ds')">
												...
												<!-- 有效 -->
															...
															<td class="content_infos" style="background-color: #ffffff;" onclick="window.parent.showContent('bszx_12','bszx','','1','Y','ds')">
								...
								<table class="content_info ct" style="border-style:none;width:100%">
												...
												<!-- 有效 -->
															...
															<td class="content_infos" style="background-color: #ffffff;" onclick="window.parent.showContent('cxzx_15','cxzx','','1','Y','')">
												...
												<!-- 有效 -->
															...
															<td class="content_infos" style="background-color: #ffffff;" onclick="window.parent.showContent('cxzx_17','cxzx','/cxzx/sbxxcx/manager','1','Y','')">
												...
												<!-- 有效 -->
															...
															<td class="content_infos" style="background-color: #ffffff;" onclick="window.parent.showContent('cxzx_18','cxzx','','1','Y','')">
												...
												<!-- 有效 -->
															...
															<td class="content_infos" style="background-color: #ffffff;" onclick="window.parent.showContent('cxzx_19','cxzx','','1','Y','')">
												...
												<!-- 有效 -->
															...
															<td class="content_infos" style="background-color: #ffffff;" onclick="window.parent.showContent('cxzx_04','cxzx','','1','Y','')">
												...
												<!-- 有效 -->
															...
															<td class="content_infos" style="background-color: #ffffff;" onclick="window.parent.showContent('cxzx_05','cxzx','','1','Y','')">
												...
												<!-- 有效 -->
															...
															<td class="content_infos" style="background-color: #ffffff;" onclick="window.parent.showContent('cxzx_06','cxzx','','1','Y','')">
												...
												<!-- 有效 -->
															...
															<td class="content_infos" style="background-color: #ffffff;" onclick="window.parent.showContent('cxzx_07','cxzx','','1','Y','')">
												...
												<!-- 有效 -->
															...
															<td class="content_infos" style="background-color: #ffffff;" onclick="window.parent.showContent('cxzx_08','cxzx','','1','Y','ds')">
												...
												<!-- 有效 -->
															...
															<td class="content_infos" style="background-color: #ffffff;" onclick="window.parent.showContent('cxzx_10','cxzx','','1','Y','')">
												...
												<!-- 有效 -->
															...
															<td class="content_infos" style="background-color: #ffffff;" onclick="window.parent.showContent('cxzx_03','cxzx','','1','Y','ds')">
								...
								<table class="content_info ct" style="border-style:none;width:100%">
												...
												<!-- 有效 -->
															...
															<td class="content_infos" style="background-color: #ffffff;" onclick="window.parent.showContent('hdzx_02','hdzx','','2','Y','')">
												...
												<!-- 有效 -->
															...
															<td class="content_infos" style="background-color: #ffffff;" onclick="window.parent.showContent('hdzx_05','hdzx','','2','Y','')">
												...
												<div class="pubSearch" style="margin-left: 0px;position: absolute;">
													...
													<ul class="pubSearchLI">										    
														    	...
														    	<!-- 有效 -->
																		...
																		<li onclick="window.parent.showContent('gzcx_03','gzcx','/gzfw/gzcx/xydjalnsrcx/xydjalnsrcxInfo','1','Y','')">
																		   <img class="gzfw_log lazyimg" src="" data-src="/res/images/login_main/gzfwlog.png">
			...
			<div class="main_right_under">
				<div class="box" id = "box2">
				 	<ul>
				 		<li id="wddb">我的待办</li>
				 		<li>服务提醒</li>	
				 		<div id="Fwtxmore" style="float: right;cursor: pointer;color: #999999;margin-right: 30px;display: none;" onclick="return false;showContent('/cxzx/bsjdjjgxxcx/manager','1','')">更多></div>	
				 		<p ><b></b></p>
				 	</ul>
