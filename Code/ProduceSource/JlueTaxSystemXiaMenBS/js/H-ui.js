...
$(document).ready(function(){
 $('.sy-djsshezhi').on('click',function(){
        $('.sy-countdown').css('display','block');
    });
 $('.countdown-exit').on('click',function(){
        $('.sy-countdown').css('display','none');
    });
 });
/* -----------修改个人信息触发效果-------------
 */ 
$(document).ready(function(){
 $('.infor-change').on('click',function(){
        $('.information').css('display','none');
        $('.change-information').css('display','block');
    });
 });
 ...
 */	
 /*tab切换*/
/*江苏会计从业*/ 
$('.jskjcy-tab li').click(function() {
    $(this).addClass('currentbg').siblings().removeClass('currentbg');
    var index = $(this).index();
    number = index;
    $('.jskjcy-content ul').hide();
    $('.jskjcy-content ul:eq(' + index + ')').show();
});
/*上海会计从业*/ 
$('.shkjcy-tab li').click(function() {
    $(this).addClass('currentbg').siblings().removeClass('currentbg');
    var index = $(this).index();
    number = index;
    $('.shkjcy-content ul').hide();
    $('.shkjcy-content ul:eq(' + index + ')').show();
});
/*江苏初级职称*/ 
$('.jscjzc-tab li').click(function() {
    $(this).addClass('currentbg').siblings().removeClass('currentbg');
    var index = $(this).index();
    number = index;
    $('.jscjzc-content ul').hide();
    $('.jscjzc-content ul:eq(' + index + ')').show();
});
/*上海初级职称*/ 
$('.shcjzc-tab li').click(function() {
    $(this).addClass('currentbg').siblings().removeClass('currentbg');
    var index = $(this).index();
    number = index;
    $('.shcjzc-content ul').hide();
    $('.shcjzc-content ul:eq(' + index + ')').show();
});
...
$(".ks-fanhui").click(function() {
        location.href = "myCourses.html"; /*返回上级菜单*/
    })
    /*tab切换*/
$('.ksmctab li').click(function() {
    $(this).addClass('on').siblings().removeClass('on');
    var index = $(this).index();
    number = index;
    $('.ksmc-tabc ul').hide();
    $('.ksmc-tabc ul:eq(' + index + ')').show();
});

// $('.ksmctab li').click(function() {
//         var $this = $(this);
//         var $t = $this.index();
//         $('.ksmc-tabc ul').css('display', 'none');
//         $('.ksmc-tabc ul').eq($t).css('display', 'block');
//     })
/*答题弹出*/
// if($("#ksmc-dt1").is(":visible")==false)
// {
// 	$("#ksmc-dt1").click(function(){
// 	$("#ksmc-tanchu1").show();
// });
// }
// else
