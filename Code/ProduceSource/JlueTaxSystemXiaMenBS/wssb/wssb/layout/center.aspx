<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="center.aspx.cs" Inherits="JlueTaxSystemXiaMenBS.wssb.wssb.layout.center" %>
        ...
        <tr>
                    ...
                    <tr>
                        <td>
                            <iframe name="I1" width="320"
                                src="/wssb/wssb/layout/left.aspx?NSRSBH=91350200MA2Y10EC4K&TABLE_ACTION=display"
                                border="0" frameborder="0" scrolling="auto" id="leftFrame"
                                onload="loadLeft();">浏览器不支持嵌入式框架，或被配置为不显示嵌入式框架。
                            </iframe>
                        </td>
                    </tr>
                </table>
            ...
            <td width="100%" align="center" valign="top" style="padding: 0;">
                ...
                <iframe name="I2" id="workspace" width="100%" border="0"
                    frameborder="0"
                    src="/wssb/MainServlet_INFORMATION.aspx?NSRSBH=91350200MA2Y10EC4K&TABLE_NAME=INFORMATION&TABLE_ACTION=display"
                    onload="loadRight();">浏览器不支持嵌入式框架，或被配置为不显示嵌入式框架。
                </iframe>
            </td>
        </tr>
    </table>
