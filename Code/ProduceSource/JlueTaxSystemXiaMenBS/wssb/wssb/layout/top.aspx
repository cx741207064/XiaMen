<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="top.aspx.cs" Inherits="JlueTaxSystemXiaMenBS.wssb.wssb.layout.top" %>
...
<html>
		...
		<script type="text/javascript">
		    ...
		    function logout() {
		        ...
		        $.ajax({
		            type: "POST",
		            async: false,
		            url: "/wssb/wssb/public/jsp/clearNsrSession.aspx",
		            data: "",
	...
	<body >
		<div id="top">
		 ...
		 <div id="time">
		 <a href="#"> 首页</a>&nbsp;|
		 <a href="#"> 退出</a>&nbsp;|&nbsp;<span id="help" >帮助</span>
