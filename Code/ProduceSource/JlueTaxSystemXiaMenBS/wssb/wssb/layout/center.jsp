			...
			<tr>
						...
						<tr>
							<td>
								<iframe name="I1" width="320"
									src="/wssb/wssb/layout/left.jsp?NSRSBH=91350200MA2Y10EC4K&TABLE_ACTION=display"
				...
				<td width="100%" align="center" valign="top" style="padding:0;"> 
					...
					<iframe name="I2" id="workspace" width="100%" border="0"
						frameborder="0"
						src="/wssb/MainServlet?NSRSBH=91350200MA2Y10EC4K&TABLE_NAME=INFORMATION&TABLE_ACTION=display"
						onload="loadRight();">
						浏览器不支持嵌入式框架，或被配置为不显示嵌入式框架。
					</iframe>
				</td>
