                ...
                success: function (result) {
                    if (typeof (result.Data) == "string") {
                        ...
                        $.each(json, function (i, v) {
                            ...
                            var Gtxpath = "tnsfwHome/index.aspx?userid=" + userId + "&username=" + username + "&classid=" + ClassId + "&courseid=" + courseid + "&sortid=" + sortid + "&questionId=" + v.QuestionId + "&userquestionId=" + v.Id + "&CompanyId=" + v.CompanyId + "&Name=" + encodeURIComponent(v.Name) + "&rand=" + new Date().getTime();
